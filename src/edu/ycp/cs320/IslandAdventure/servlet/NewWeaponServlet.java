...
public class NewWeaponServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		req.getRequestDispatcher("/_view/newWeapon.jsp").forward(req, resp);
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		System.out.println("NewWeaponServlet doPost");
		...
		try {
			...
			if (!(name.equals("")) && !(description.equals("")) && !(locationX.equals("")) &&
					!(locationY.equals("")) && !(locationZ.equals(""))) 
			{
				...
				Integer weaponDamage = Integer.parseInt(damage);
				...
				gameEngine.insertNewItemIntoDatabase(account, account_id, itemToAdd, 1, weaponDamage);
		...
		if (errorMessage != null){
			...
			req.getRequestDispatcher("/_view/newWeapon.jsp").forward(req, resp); //Go to this page
		}
		else
		{
